...
@MainActor
@Observable
final class SpeechAnalyzerDemoModel {
    ...
    private func startSpeechAnalysis() async throws {
        guard await requestMicrophonePermission() else {
            throw SpeechAnalyzerDemoError.microphonePermissionDenied
        }

        guard SpeechTranscriber.isAvailable else {
            throw SpeechAnalyzerDemoError.unsupportedDevice
        }

        guard let locale = await SpeechTranscriber.supportedLocale(equivalentTo: .current) else {
            throw SpeechAnalyzerDemoError.unsupportedLocale
        }
        ...
        guard let analysisFormat = await SpeechAnalyzer.bestAvailableAudioFormat(
            ...
            throw SpeechAnalyzerDemoError.unavailableAudioInput
        }
